...
- [Chapter 1. Starting with Gradle](#chapter-1-starting-with-gradle)
  * [Little bit of Groovy](#little-bit-of-groovy)
  * [Declarative builds and convention over configuration](#declarative-builds-and-convention-over-configuration)
  * [Incremental builds](#incremental-builds)
  * [Multi-project builds](#multi-project-builds)
  * [Gradle Wrapper](#gradle-wrapper)
  * [Getting started](#getting-started)
    + [Installing Gradle](#installing-gradle)
    + [Writing our first build script](#writing-our-first-build-script)
  * [Default Gradle tasks](#default-gradle-tasks)
  * [Task name abbreviation](#task-name-abbreviation)
  * [Executing multiple tasks](#executing-multiple-tasks)
  * [Command-line options](#command-line-options)
  * [Logging options](#logging-options)
  * [Changing the build file and directory](#changing-the-build-file-and-directory)
  * [Running tasks without execution](#running-tasks-without-execution)
  * [Gradle daemon](#gradle-daemon)
  * [Profiling](#profiling)
  * [Offline usage](#offline-usage)
  * [Understanding the Gradle graphical user interface](#understanding-the-gradle-graphical-user-interface)
- [Chapter 2. Creating Gradle Build Scripts](#chapter-2-creating-gradle-build-scripts)
  * [Writing a build script](#writing-a-build-script)
  * [Defining tasks](#defining-tasks)
  * [Defining actions with the Action interface](#defining-actions-with-the-action-interface)
  * [Build scripts are Groovy code](#build-scripts-are-groovy-code)
  * [Defining dependencies between tasks](#defining-dependencies-between-tasks)
  * [Defining dependencies via tasks](#defining-dependencies-via-tasks)
  * [Defining dependencies via closures](#defining-dependencies-via-closures)
  * [Setting default tasks](#setting-default-tasks)
  * [Organizing tasks](#organizing-tasks)
  * [Adding a description to tasks](#adding-a-description-to-tasks)
  * [Grouping tasks together](#grouping-tasks-together)
  * [Getting more information about a task](#getting-more-information-about-a-task)
  * [Adding tasks in other ways](#adding-tasks-in-other-ways)
  * [Using task rules](#using-task-rules)
  * [Accessing tasks as project properties](#accessing-tasks-as-project-properties)
  * [Adding additional properties to tasks](#adding-additional-properties-to-tasks)
  * [Avoiding common pitfalls](#avoiding-common-pitfalls)
  * [Skipping tasks](#skipping-tasks)
    + [Using onlyIf predicates](#using-onlyif-predicates)
    + [Skipping tasks by throwing StopExecutionException](#skipping-tasks-by-throwing-stopexecutionexception)
    + [Enabling and disabling tasks](#enabling-and-disabling-tasks)
    + [Skipping from the command line](#skipping-from-the-command-line)
    + [Skipping tasks that are up to date](#skipping-tasks-that-are-up-to-date)
  * [Summary](#summary)
- [Chapter 3. Working with Gradle Build Scripts](#chapter-3-working-with-gradle-build-scripts)
  * [Working with files](#working-with-files)
    + [Locating files](#locating-files)
    + [Using file collections](#using-file-collections)
    + [Working with file trees](#working-with-file-trees)
    + [Copying files](#copying-files)
    + [Archiving files](#archiving-files)
  * [Project properties](#project-properties)
    + [Defining custom properties in script](#defining-custom-properties-in-script)
    + [Defining properties using an external file](#defining-properties-using-an-external-file)
    + [Passing properties via the command line](#passing-properties-via-the-command-line)
    + [Defining properties via system properties](#defining-properties-via-system-properties)
    + [Adding properties via environment variables](#adding-properties-via-environment-variables)
  * [Using logging](#using-logging)
    + [Controlling output](#controlling-output)
  * [Using the Gradle Wrapper](#using-the-gradle-wrapper)
    + [Creating wrapper scripts](#creating-wrapper-scripts)
    + [Customizing the Gradle Wrapper](#customizing-the-gradle-wrapper)
- [Chapter 4. Using Gradle for Java Projects](#chapter-4-using-gradle-for-java-projects)
  * [Why plugins?](#why-plugins)
  * [Getting started with the Java plugin](#getting-started-with-the-java-plugin)
    + [Using the Java plugin](#using-the-java-plugin)
    + [Working with source sets](#working-with-source-sets)
    + [Creating a new source set](#creating-a-new-source-set)
    + [Custom configuration](#custom-configuration)
    + [Working with properties](#working-with-properties)
    + [Creating Javadoc documentation](#creating-javadoc-documentation)
    + [Assembling archives](#assembling-archives)
- [Chapter 5. Dependency Management](#chapter-5-dependency-management)
  * [Dependency configuration](#dependency-configuration)
  * [Repositories](#repositories)
    + [Adding Maven repositories](#adding-maven-repositories)
    + [Adding Ivy repositories](#adding-ivy-repositories)
  * [Adding a local directory repository](#adding-a-local-directory-repository)
  * [Defining dependencies](#defining-dependencies)
    + [Using external module dependencies](#using-external-module-dependencies)
  * [Using project dependencies](#using-project-dependencies)
  * [Using file dependencies](#using-file-dependencies)
    + [Using client module dependencies (edge case)](#using-client-module-dependencies-edge-case)
    + [Using Gradle and Groovy dependencies](#using-gradle-and-groovy-dependencies)
    + [Accessing configuration dependencies](#accessing-configuration-dependencies)
  * [Setting dynamic versions](#setting-dynamic-versions)
  * [Resolving version conflicts](#resolving-version-conflicts)
  * [Adding optional ANT tasks](#adding-optional-ant-tasks)
  * [Using dependency configurations as files](#using-dependency-configurations-as-files)
- [Chapter 6. Testing, Building, and Publishing Artifacts](#chapter-6-testing-building-and-publishing-artifacts)
  * [Testing our projects](#testing-our-projects)
  * [Using TestNG for testing](#using-testng-for-testing)
  * [Configuring the test process](#configuring-the-test-process)
  * [Determining tests](#determining-tests)
  * [Logging test output](#logging-test-output)
  * [Changing the test report directory](#changing-the-test-report-directory)
  * [Running Java applications](#running-java-applications)
  * [Running an application from a project](#running-an-application-from-a-project)
  * [Running an application as a task](#running-an-application-as-a-task)
  * [Running an application with the application plugin](#running-an-application-with-the-application-plugin)
  * [Creating a distributable application archive](#creating-a-distributable-application-archive)
  * [Publishing artifacts](#publishing-artifacts)
  * [Uploading our artifacts to a Maven repository](#uploading-our-artifacts-to-a-maven-repository)
  * [Signing artifacts](#signing-artifacts)
  * [Packaging Java Enterprise Edition applications](#packaging-java-enterprise-edition-applications)
    + [Creating a WAR file](#creating-a-war-file)
    + [Creating an EAR file](#creating-an-ear-file)
- [Chapter 7. Multi-project Builds](#chapter-7-multi-project-builds)
  * [Working with multi-project builds](#working-with-multi-project-builds)
  * [Executing tasks by project path](#executing-tasks-by-project-path)
  * [Using a flat layout](#using-a-flat-layout)
  * [Ways of defining projects](#ways-of-defining-projects)
  * [Filtering projects](#filtering-projects)
  * [Defining task dependencies between projects](#defining-task-dependencies-between-projects)
  * [Defining configuration dependencies](#defining-configuration-dependencies)
  * [Working with Java multi-project builds](#working-with-java-multi-project-builds)
- [TODO. After playing around more with Gradle](#todo-after-playing-around-more-with-gradle)
  * [Using partial builds](#using-partial-builds)
  * [Using the Jetty plugin](#using-the-jetty-plugin)
- [Chapter 8. Mixed Languages](#chapter-8-mixed-languages)
  * [Using the Groovy plugin](#using-the-groovy-plugin)
  * [Using the Scala plugin](#using-the-scala-plugin)
- [Chapter 9. Maintaining Code Quality](#chapter-9-maintaining-code-quality)
  * [Using the Checkstyle plugin](#using-the-checkstyle-plugin)
  * [Using the PMD plugin](#using-the-pmd-plugin)
  * [Using the FindBugs plugin](#using-the-findbugs-plugin)
  * [Using the JDepend plugin](#using-the-jdepend-plugin)
- [Chapter 10. Writing Custom Tasks and Plugins](#chapter-10-writing-custom-tasks-and-plugins)
  * [Creating a custom task](#creating-a-custom-task)
    + [Creating a custom task in the build file](#creating-a-custom-task-in-the-build-file)
  * [Using incremental build support](#using-incremental-build-support)
  * [Creating a task in the project source directory](#creating-a-task-in-the-project-source-directory)
    + [Writing tests](#writing-tests)
  * [Creating a task in a standalone project](#creating-a-task-in-a-standalone-project)
  * [Creating a custom plugin](#creating-a-custom-plugin)
- [Chapter 11. Gradle in the Enterprise](#chapter-11-gradle-in-the-enterprise)
  * [Using Jenkins](#using-jenkins)
  * [Using JetBrains TeamCity](#using-jetbrains-teamcity)
  * [Using Atlassian Bamboo](#using-atlassian-bamboo)
- [Chapter 12. IDE Support](#chapter-12-ide-support)

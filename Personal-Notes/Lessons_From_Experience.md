...
As it turns out, there aren't straightforward solutions to this problem. Most of time the advice is just use swagger generated by Spring Fox from already running services. By default you can find it under /v2/api-docs url (example: http://some-service/v2/api-docs.).
